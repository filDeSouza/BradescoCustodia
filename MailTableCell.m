...
-(instancetype) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _mailFrom.font = [UIFont fontWithName:@"HelveticaNeue" size:13.0f];
...
-(void) layoutSubviews
{
    ...
    _mailFrom.frame = CGRectMake(leftPadding, 25.0, textWidth, 13);
    ...
    CGFloat messageHeight = self.contentView.bounds.size.height - (_mailSubject.frame.origin.y + _mailSubject.frame.size.height) - topPadding;
    ...
    _mailTime.frame = CGRectMake(280.0, 10.0, textWidth, 13);
