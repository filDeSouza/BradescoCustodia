...
#define kDayColor [UIColor grayColor]
#define kMonthColor [UIColor grayColor]
#define kYearColor [UIColor darkGrayColor]
#define kDayFont [UIFont systemFontOfSize: 22.0]
...
const NSUInteger kDayComponent = 0;
const NSUInteger kMonthComponent = 1;
const NSUInteger kYearComponent = 2;
const NSUInteger kMinYear = 2002;
const NSUInteger kMaxYear = 2060;
const CGFloat kRowHeight = 30.0;
BOOL firstTimeLoad;
NSString *currentMonthString;
integer_t selectedYearRow;
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component {
    ...
    if ([self.delegate respondsToSelector: @selector(pickerDidSelectMonth:andDay:andYear:)])
        [self.delegate pickerDidSelectMonth:_months[_monthIndex]
                                     andDay:_days[_DayIndex]
...
//            {
//                int yearint = [[_years objectAtIndex:selectedYearRow]intValue ];
//                
